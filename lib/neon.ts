  ...
  try {
    ...
    if (
      ...
      return {
        success: false,
        message:
          "Alguna tabla no existe. Verifica que hayas ejecutado el script de creación de tablas.",
    ...
    if (error.message?.includes("connect")) {
      return {
        success: false,
        message:
          "Error de conexión. Verifica tu conexión a internet y la URL de Neon.",
